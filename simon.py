...
def draw_normal_game_state():
  ...
  if get_global_game_state() == GS_INTRO:
    ...
    screen.draw.text(f"{PLAYERS[1].game.get_sequence_len(1)}", center=((WIDTH / 2) + (WIDTH / 4) + PADDING, y_start + (PADDING * 12)), fontsize=170, shadow=(1, 1), scolor="#202020", color="#FFFFFF")
